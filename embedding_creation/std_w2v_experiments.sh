...
std_w2v_path=$(python -c 'import embedding_creation; print(embedding_creation.CONSTANTS.LOCAL_W2V_EXECUTABLE_PATH)')
...
#python $std_w2v_path -c giga-wiki-40k.txt -o std-w2v-s1-t2e5-v40k-iter5-giga-wiki -t 2.45e-5 -p 20 -s 1 -l 0.025 -i 5

#python $std_w2v_path -c giga-wiki-40k.txt -o std-w2v-s1-t2e5-v40k-iter5-giga-wiki-nohyper -t 1 -a 1 -k 1 -p 20 -s 1 -l 0.025 -i 5

python $std_w2v_path -c /home/rldata/hilbert-embeddings/gigaword_tokenized_cat/giga-wiki-lowered-50k.txt -o /home/rldata/hilbert-embeddings/embeddings/std-w2v-t2e5-v50k-iter5-giga-wiki -t 1e-5 -k 15 -p 20 -s 1 -l 0.025 -i 5
